...
import { Home, Building2, HardHat, Ruler, Castle, CheckCircle2, ChevronDown } from 'lucide-react';
...
const faqs = [
  {
    q: 'What is the cost of house construction in Ujjain?',
    a: 'The cost of house construction in Ujjain typically ranges from ₹1,200 to ₹2,500 per square foot, depending on the type of construction, materials used, and design complexity. At Konark Associates, we offer transparent pricing with detailed cost breakdowns. Contact us at 098279 53774 for a free estimate tailored to your project.',
  },
  {
    q: 'Do you provide construction with material supply?',
    a: 'Yes, we offer complete construction with material supply services. This means we handle everything from sourcing premium-quality cement, steel, bricks, sand, and other building materials to managing skilled labor. You get a hassle-free, single-point-of-contact building experience with guaranteed material quality.',
  },
  {
    q: 'How long does it take to construct a house in Ujjain?',
    a: 'A standard residential house construction in Ujjain typically takes 8 to 14 months, depending on the size, design complexity, and weather conditions. Our team follows strict timelines with regular progress updates, ensuring on-time delivery without compromising on quality.',
  },
  {
    q: 'What types of construction projects do you handle?',
    a: 'We handle a wide range of construction projects including residential buildings, commercial complexes, bungalows, row houses, farmhouses, and renovation projects. Whether it\'s a single-floor home or a multi-story commercial building, our experienced team of civil engineers delivers excellence across Ujjain, Indore, and Barnagar.',
  },
  {
    q: 'Do you provide construction drawings and 3D elevation designs?',
    a: 'Yes, we provide complete architectural planning services including 2D floor plans, 3D elevation designs, structural drawings, and MEP (Mechanical, Electrical, Plumbing) layouts. Our design team creates detailed blueprints so you can visualize your project before construction begins.',
  },
  {
    q: 'Why should I choose Konark Associates for construction?',
    a: 'Konark Associates is a 5-star rated construction company with over 100 completed projects across Ujjain, Indore, and Barnagar. We offer transparent pricing with no hidden costs, premium quality materials, experienced civil engineers, strict timeline adherence, and complete construction with material supply. We are your single-point solution from planning to possession.',
  },
];
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              <motion.div
                ...
                className="border border-charcoal-100 rounded-2xl overflow-hidden hover:border-teal-300 transition-colors"
              >
                <button
                  onClick={() => toggleFaq(i)}
